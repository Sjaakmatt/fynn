      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <Link href="/signup" style={{ padding: '10px 16px', borderRadius: 12, fontSize: 14, backgroundColor: 'var(--brand)', color: 'white', textDecoration: 'none', fontWeight: 600, whiteSpace: 'nowrap' }}>Gratis starten</Link>
          </div>
        </div>
      </nav>
